...
import {AccountTree, Close, Visibility, VisibilityOff} from "@mui/icons-material";
        ...
        <>
            <div className='bpmn-diagram'>
                <Box sx={{display: 'flex', 'justifyContent': 'space-between', mb: 2}}>
                    {createNewMode && (<Box sx={{display: 'flex', gap: 2}}>
                        <Button
                            variant="outlined"
                            color="primary"
                            component="label"
                    ...
                    <Box sx={{display: 'flex', gap: 2}}>
                        ...
                        >{propPanelVisible ? 'Hide Prop Panel' : 'Show Prop Panel'}</Button>
                    </Box>
                </Box>
                <div className="content">
                    <div
                        id="bpmn-container"
                        style={{width: '100%', height: '500px', float: 'left', border: '1px solid #303633'}}
                        ref={containerRef}
                    />
                    <div className={propPanelVisible ? 'visible' : 'hidden'}
                         id="propertiesPanel"
                         style={{
                             width: '20%',
                             float: 'right',
            ...
            <div>
                {errorMessages.map((error, index) => (
                    ...
                    >
                        <Alert
                            severity="error"
                            sx={{display: 'flex', 'alignItems': 'center', fontSize: '14px', mb: 2}}
                            action={
                                <IconButton
                                    size="small"
                                    aria-label="close"
